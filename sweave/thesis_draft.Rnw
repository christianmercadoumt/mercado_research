...
%% given those results, here are some figures. 
...
%show a table of smooths, edf, significance/pvalue

%show smooths


% The top 4 plots show the 1 dimensional smooth effects for diameter at breast height (DBH), tree crown ratio, ratio of basal area larger than a subject (BAL), and plot basal area (BA). Effect scales vary by smooth.
%describe smooths
