...
and in-turn, relates to inter-tree competitive dynamics. Productivity in forests can 
...
competition for light can sufficiently capture the effect of biodiversity on productivity \citep{Morin2011}. 
