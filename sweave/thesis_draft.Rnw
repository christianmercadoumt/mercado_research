...
constrains a smoother's complexity as it grows higher \citep{Pedersen2019}. 
Mgcv allows for smoothing parameters to be estimated via different methods - 
the maximum likelihood method was used in this study because it allows for 
better comparison across models that use different terms and smoothing parameters. 
Random effects may be coded as smooths in this format, 
which is essentially equivalent to other mixed-model approaches, however, 
when fitting large numbers of intercepts (as done in this study) 
computation can extremely slow \citep{Pedersen2019}. %%%more here?? do I talk about using both methods since the way random effects are handled with the gamm case is kinda weird? (see pedersen 2019 page 34)
With mgcv, the thin-plate regression smoother (TPRS) type
is the default due to its simple and effective behavior \citep{Wood2003}
and is what was used in the present study for all terms including interactions. 
...
the purpose of model validation and quantifying variable effect size.
...
% 
% -DISTRIBUTION OF BAI HERE-
% 
% -Figure showing distribution of bai?-
...
0.65 or higher were not considered together. Although somewhat arbitrary, 
this threshold was selected because a 0.65 correlation means that 
variation shared between variables exceeds 40\%. Additionally, variables 
...
but was not used as strict selection criteria because
it changed in accordance with RMSE. %Do i even say this?
...
subsets of the PGP data for different types of species-mixtures were determined 
based on species representation quantified by proportions of plot basal area. 
% Mixture-types were identified by evaluating
% proportions of plot basal area occupied by larch and other species it was mixed with.
...
at least 70\% western larch to provide reference conditions to compare each 
species-mixture to. 

The mgcv package allows for flexible model fitting regimes where 
smooth functional relationships between a predictor and the response 
variable can vary across different groups \citep{Pedersen2019}. 
Such strategies were employed to assess western larch growth 
across each identified type of mixture compared to the pure larch 
stand condition. Thus, an interactive additive model was fit to the identified 
base model formulation where each mixture was estimated with a unique intercept
and each smooth term was evaluated for each type of mixture, resulting in a model 
containing separate smooths for each species-mixture. Each mixture was evaluated 
against the pure larch condition using an equivalence test 
to identify evidence for a difference between estimated growth within 
each mixture and the reference pure larch condition for each fitted smooth. The 
model from equation \ref{eq:baiform} may be modified as follows:
...
a mixture $j$, $\beta_0$ is the model intercept for pure larch conditions, 
$\beta_{1j}$ represents the difference between $\beta_0$ and the intercept 
for mixture $j$, $f_{j}$ is a smooth function for model predictor $x_n$ in a 
mixture. 
...
\toprule
spcode & SPECIES\_SYMBOL & r1 & r2 & r3 & r4 & r5\\
\midrule
\cellcolor{gray!6}{RC} & \cellcolor{gray!6}{THPL} & \cellcolor{gray!6}{0.03000} & \cellcolor{gray!6}{0.02380} & \cellcolor{gray!6}{0.00490} & \cellcolor{gray!6}{0.008915} & \cellcolor{gray!6}{1.7800}\\
WH & TSHE & 0.03000 & 0.02150 & 0.00363 & 0.011109 & 1.7250\\
\cellcolor{gray!6}{ES} & \cellcolor{gray!6}{PIEN} & \cellcolor{gray!6}{0.03000} & \cellcolor{gray!6}{0.01730} & \cellcolor{gray!6}{0.00259} & \cellcolor{gray!6}{0.007875} & \cellcolor{gray!6}{1.7360}\\
AF & ABLA & 0.03000 & 0.02160 & 0.00405 & 0.011402 & 1.7560\\
\cellcolor{gray!6}{GF} & \cellcolor{gray!6}{ABGR} & \cellcolor{gray!6}{0.04000} & \cellcolor{gray!6}{0.02700} & \cellcolor{gray!6}{0.00405} & \cellcolor{gray!6}{0.015248} & \cellcolor{gray!6}{1.7333}\\
\addlinespace
WP & PIMO3 & 0.03000 & 0.01670 & 0.00230 & 0.009884 & 1.6667\\
\cellcolor{gray!6}{DF} & \cellcolor{gray!6}{PSME} & \cellcolor{gray!6}{0.11000} & \cellcolor{gray!6}{0.03330} & \cellcolor{gray!6}{0.00259} & \cellcolor{gray!6}{0.017299} & \cellcolor{gray!6}{1.5571}\\
PP & PIPO & 0.03000 & 0.01800 & 0.00281 & 0.007813 & 1.7680\\
\cellcolor{gray!6}{WL} & \cellcolor{gray!6}{LAOC} & \cellcolor{gray!6}{0.02000} & \cellcolor{gray!6}{0.01480} & \cellcolor{gray!6}{0.00338} & \cellcolor{gray!6}{0.007244} & \cellcolor{gray!6}{1.8182}\\
LP & PICO & 0.01925 & 0.01676 & 0.00365 & 0.009187 & 1.7600\\
\addlinespace
\cellcolor{gray!6}{AS} & \cellcolor{gray!6}{POTR5} & \cellcolor{gray!6}{0.03000} & \cellcolor{gray!6}{0.02380} & \cellcolor{gray!6}{0.00490} & \cellcolor{gray!6}{0.008915} & \cellcolor{gray!6}{1.7800}\\
CO & POPUL & 0.03000 & 0.02150 & 0.00363 & 0.011109 & 1.7250\\
\cellcolor{gray!6}{PB} & \cellcolor{gray!6}{BEPA} & \cellcolor{gray!6}{0.03000} & \cellcolor{gray!6}{0.02380} & \cellcolor{gray!6}{0.00490} & \cellcolor{gray!6}{0.008915} & \cellcolor{gray!6}{1.7800}\\
MH & TSME & 0.03000 & 0.02150 & 0.00363 & 0.011109 & 1.7250\\
\cellcolor{gray!6}{RM} & \cellcolor{gray!6}{JUSC2} & \cellcolor{gray!6}{0.01925} & \cellcolor{gray!6}{0.01676} & \cellcolor{gray!6}{0.00365} & \cellcolor{gray!6}{0.009187} & \cellcolor{gray!6}{1.7600}\\
\addlinespace
WB & PIAL & 0.02000 & 0.01480 & 0.00338 & 0.007244 & 1.8182\\
\cellcolor{gray!6}{PY} & \cellcolor{gray!6}{TABR2} & \cellcolor{gray!6}{0.01925} & \cellcolor{gray!6}{0.01676} & \cellcolor{gray!6}{0.00365} & \cellcolor{gray!6}{0.009187} & \cellcolor{gray!6}{1.7600}\\
OS & 2TE & 0.03000 & 0.02150 & 0.00363 & 0.011109 & 1.7250\\
\bottomrule
\end{tabular}
\end{table}
...
to ensure that predictions of growth were positive and trunkated at zero.
...
transformations were applied as in previous works (CITE). Aspect was best 
...
\toprule
\hspace{1em}Smooth & EDF & Explained deviance & RMSE ($cm^2/yr.$)\\
\midrule
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Size}}\\
\hspace{1em}\cellcolor{gray!6}{DBH} & \cellcolor{gray!6}{8} & \cellcolor{gray!6}{30.82} & \cellcolor{gray!6}{5.64312}\\
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Competition \& density}}\\
\hspace{1em}Crown ratio & 2 & 62.87 & 4.30911\\
\hspace{1em}\cellcolor{gray!6}{BAL} & \cellcolor{gray!6}{8} & \cellcolor{gray!6}{} & \cellcolor{gray!6}{}\\
\hspace{1em}BA & 9 &  & \\
\addlinespace[0.3em]
\multicolumn{4}{l}{\textbf{Site}}\\
\hspace{1em}\cellcolor{gray!6}{Aspect} & \cellcolor{gray!6}{26} & \cellcolor{gray!6}{67.39} & \cellcolor{gray!6}{4.01197}\\
\addlinespace[0.3em]
\textbf{\cellcolor{gray!6}{Base model}} & \textbf{\cellcolor{gray!6}{1389}} & \textbf{\cellcolor{gray!6}{84.91}} & \textbf{\cellcolor{gray!6}{3.32142}}\\
\hspace{1em}Random intercept & 1337 &  & \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}{llrrr}
\toprule
Variable & Stat & Pure larch & Larch-lodgepole & Larch-Douglas-fir\\
\midrule
 & \cellcolor{gray!6}{min} & \cellcolor{gray!6}{0.0078540} & \cellcolor{gray!6}{0.0044392} & \cellcolor{gray!6}{0.0150250}\\
\cmidrule{2-5}
 & max & 8.2561055 & 4.6110381 & 5.6155969\\
\cmidrule{2-5}
 & \cellcolor{gray!6}{sd} & \cellcolor{gray!6}{1.1922186} & \cellcolor{gray!6}{0.8926184} & \cellcolor{gray!6}{0.8492781}\\
\cmidrule{2-5}
 & mean & 1.3863251 & 1.1672285 & 0.9379665\\
\cmidrule{2-5}
\multirow[c]{-5}*{bai} & \cellcolor{gray!6}{n} & \cellcolor{gray!6}{1358.0000000} & \cellcolor{gray!6}{396.0000000} & \cellcolor{gray!6}{638.0000000}\\
\cmidrule{1-5}
\multirow[c]{5}*{dbh} & min & 0.2000000 & 0.3000000 & 0.2000000\\
\cmidrule{2-5}
 & \cellcolor{gray!6}{max} & \cellcolor{gray!6}{22.7000000} & \cellcolor{gray!6}{8.9000000} & \cellcolor{gray!6}{15.3000000}\\
\cmidrule{2-5}
 & sd & 4.6192626 & 1.6722070 & 2.4535962\\
\cmidrule{2-5}
 & \cellcolor{gray!6}{mean} & \cellcolor{gray!6}{5.3473490} & \cellcolor{gray!6}{3.6151515} & \cellcolor{gray!6}{4.8973354}\\
\cmidrule{2-5}
 & n & 1358.0000000 & 396.0000000 & 638.0000000\\
\cmidrule{1-5}
\multirow[c]{5}*{cr} & \cellcolor{gray!6}{min} & \cellcolor{gray!6}{0.0800000} & \cellcolor{gray!6}{0.2000000} & \cellcolor{gray!6}{0.0800000}\\
\cmidrule{2-5}
 & max & 0.9300000 & 0.9300000 & 0.9300000\\
\cmidrule{2-5}
 & \cellcolor{gray!6}{sd} & \cellcolor{gray!6}{0.2533134} & \cellcolor{gray!6}{0.1803424} & \cellcolor{gray!6}{0.2398042}\\
\cmidrule{2-5}
 & mean & 0.6054050 & 0.7795960 & 0.5251097\\
\cmidrule{2-5}
 & \cellcolor{gray!6}{n} & \cellcolor{gray!6}{1358.0000000} & \cellcolor{gray!6}{396.0000000} & \cellcolor{gray!6}{638.0000000}\\
\cmidrule{1-5}
\multirow[c]{5}*{bal} & min & 0.0000000 & 0.0000000 & 0.0000000\\
\cmidrule{2-5}
 & \cellcolor{gray!6}{max} & \cellcolor{gray!6}{0.9997369} & \cellcolor{gray!6}{0.9981064} & \cellcolor{gray!6}{0.9997904}\\
\cmidrule{2-5}
 & sd & 0.3016902 & 0.2664636 & 0.2876608\\
\cmidrule{2-5}
 & \cellcolor{gray!6}{mean} & \cellcolor{gray!6}{0.5887705} & \cellcolor{gray!6}{0.6396606} & \cellcolor{gray!6}{0.5843163}\\
\cmidrule{2-5}
 & n & 1358.0000000 & 396.0000000 & 638.0000000\\
\cmidrule{1-5}
\multirow[c]{5}*{ba} & \cellcolor{gray!6}{min} & \cellcolor{gray!6}{1.0002918} & \cellcolor{gray!6}{0.5563237} & \cellcolor{gray!6}{2.8994283}\\
\cmidrule{2-5}
 & max & 243.4854337 & 102.1486686 & 301.2394704\\
\cmidrule{2-5}
 & \cellcolor{gray!6}{sd} & \cellcolor{gray!6}{50.0153542} & \cellcolor{gray!6}{23.4771302} & \cellcolor{gray!6}{69.5882709}\\
\cmidrule{2-5}
 & mean & 55.9594915 & 40.1893497 & 94.5666217\\
\cmidrule{2-5}
 & \cellcolor{gray!6}{n} & \cellcolor{gray!6}{1358.0000000} & \cellcolor{gray!6}{396.0000000} & \cellcolor{gray!6}{638.0000000}\\
\cmidrule{1-5}
NA & NA & 497.0000000 & 211.0000000 & 320.0000000\\
\bottomrule
\end{tabular}
\end{table}
