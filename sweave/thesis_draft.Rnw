...
growth and development at individual tree and stand levels. Western larch is
...
Maximum stand density can be impacted at different 
levels of species purity in a stand for different focal species. 
Weiskittel et al. (\citeyear{Weiskittel2009a}) found that the 
density of self-thinning for a given species was positively 
associated with stand purity, meaning an increase in diversity 
could reduce a site's maximum potential density. Conversely, Pretzsch and Biber 
(\citeyear{Pretzsch2016}) showed that stand carrying capacity was 
positively impacted in more diverse stands. Moreover, 
maximum stand density was increased in ponderosa pine and 
Douglas-fir when species-diversity was higher, but in 
comparatively shade-tolerant grand fir, the relative impact 
...
stand purity and its relationship with density 
may help explain varying competitive effects on tree growth across mixtures. 

Species shade tolerance relates to the physiological and 
morphological characteristics which drive growth \citep{Reich1998}, 
and in-turn, relates to inter-tree competitive dynamics \citep{Canham2006}. 
Productivity in forests can be enhanced by mixing shade tolerant and 
intolerant species \citep{Williams2017}, where different species' 
light requirement niches are considered complementary \citep{Thurm2016}. 
Searle and Chen (\citeyear{Searle2020}) found that positive complementary effects on 
individual tree growth increase with both community 
...
Furthermore, due to complementary effects, quantifying community 
competition for light can sufficiently capture the 
effects of biodiversity on productivity \citep{Morin2011}.
...
(iii) identify, quantify, and compare different species-composition informed metrics within an empirical modelling framework
