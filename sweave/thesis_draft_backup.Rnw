...
measures of stand species purity crown density. 
...
\midrule
\cellcolor{gray!6}{1401} & \cellcolor{gray!6}{10} & \cellcolor{gray!6}{53} & \cellcolor{gray!6}{150}\\
1402 & 10 & 188 & 631 & 5\\
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{../17.figures_saved/ccf_pur_shd.png}
...
--- A blurb about GAMs, their usage, the pros, the cons. 
- The use of generalized additive models is becoming more prevalent in 
ecological research to capture non-linear patterns that exist in 
ecosystems.

 -- Since the models fit here estimate BAI conditional on a gamma 
 distribution with a log-link function, the model terms together may be considered 
 to have a multiplicative effect, allowing for interpretation 
 of terms as interactive with one another. 
 
 % \[g(E(BAI)) \~ \Gamma(\mu,\alpha)\]
 
 --- Therefore, a one-unit change in a value of diameter will have a multiplicative 
 effect on the response. 
 
 --- This provides the flexibility to remark on 
...
- Vospernik 2020 found that only including BAL as a competition measure 
...
competitive effects in addition to community effects. 

- Intially ccf was considered as a Competition measure, 
and CCF was selected in a model formulation with slope as well, however 
the benefit to RMSE that this formula provided was marginal compared 
to the formula that included BA. Further, to accommodate analyses which 
