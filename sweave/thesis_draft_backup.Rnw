...
that below-ground competition for resources can be asymmetric among species 
\citep(Rewald2009), however the resulting effects on productivity may vary 
...
shade-tolerance and phyologenetic dissimilarity, showing that  
shade-tolerance can encapsulate its effects on inter-specific competition, 
and that positive niche complementary effects on tree growth increase with 
