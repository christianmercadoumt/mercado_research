...
\cite{Pretzsch2017a}. Competition describes how these traits differ among 
trees, where it may increase if there is a mis-match in any of these traits within 
...
with other western larch vs. when it was growing with either lodgepole pine 
or Douglas-fir. For lodgepole pine mixtures, this was made apparent in 
the partial relationships of tree size, competition and site, whereas 
