...
knowledgebase that exists for species-mixing effects on larch worldwide. 
\cite{Vospernik2021} showed that the \emph{L. decidua} mutually benefitted in 
...
assessed the height of \emph{L. olgensis} and found 
