...
with the addition with a simple measure of proportional basal area than 
by CCF. Similarly, \cite{Dirnberger2014} and 
\cite{Dirnberger2017} both found that species-proportional measures of 
composition were more effective than crown-area based measures in two-species 
stands. 
