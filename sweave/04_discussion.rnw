...
\cite[displayed by][]{Weiskittel2011}. This is somewhat unsurprising given 
...
are accurate for the entire area estimated. \cite{Stage2007} suggested that 
...
may simply imply that resources are scarce, and that growth is limited. Thus 
...
larch growth and both purity of larch and shade-intolerance exists. Others have 
attributed differences in productivity to shade-tolerance 
