...
level of uncertainty associated with them, which may be corrected for, 
resulting in wider confidence bands around a particular partial effects smooth. 
...
model and its formulation will be referred to herein as SCPt. Once identified, 
