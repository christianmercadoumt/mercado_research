...
area taken up by larch (WL ratio) as well as a stand shade-intolerance metric (Shade), 
...
crown competition factor [CCF\;Krajicek *et al.*, -@Krajicek1961], basal area larger than the subject tree (BAL), and 
...
{%
```{r figure2, include = T, fig.align='left', fig.dim=c(4, 1.8)}
limits <- c(0.8, 2.15)
