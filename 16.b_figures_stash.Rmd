...
```{r new mixtures partial data }

smest.diam <- smooth_estimates(mix.diff.gam.nospr.m1, smooth = 's(DIAMETER)', partial_match = T, unconditional = T) %>% 
  mutate(upper = est+(2*se), lower = est-(2*se), 
         facets = case_when(
           is.na(omixtype) ~ 'Pure larch',
           omixtype == 'pico' ~ 'Larch-lodgepole',
...
smest.cr <- smooth_estimates(mix.diff.gam.nospr.m1, smooth = 's(cr', partial_match = T, unconditional = T) %>% 
  mutate(upper = est+(2*se), lower = est-(2*se), 
         facets = case_when(
           is.na(omixtype) ~ 'Pure larch',
           omixtype == 'pico' ~ 'Larch-lodgepole',
...
smest.bal <- smooth_estimates(mix.diff.gam.nospr.m1, smooth ='s(bal', partial_match = T, unconditional = T) %>% 
  mutate(upper = est+(2*se), lower = est-(2*se), 
         facets = case_when(
           is.na(omixtype) ~ 'Pure larch',
           omixtype == 'pico' ~ 'Larch-lodgepole',
...
smest.ba <- smooth_estimates(mix.diff.gam.nospr.m1, smooth = 's(ba.pl', partial_match = T, unconditional = T) %>% 
  mutate(upper = est+(2*se), lower = est-(2*se), 
         facets = case_when(
           is.na(omixtype) ~ 'Pure larch',
           omixtype == 'pico' ~ 'Larch-lodgepole',
...
smest.asp <- smooth_estimates(mix.diff.gam.nospr.m1, smooth = 'asp', partial_match = T, unconditional = T, dist = 0.2) %>% 
  mutate(upper = est+(2*se), lower = est-(2*se), 
         facets = case_when(
           is.na(omixtype) ~ 'Pure larch',
           omixtype == 'pico' ~ 'Larch-lodgepole',
...
lay <- rbind(c(1,2),
             ...
             c(9,10),
             c(11,12))
grid.arrange( mixpl.d1,mixpl.d2, 
                        mixpl.cr1,mixpl.cr2, 
                        mixpl.bal1,mixpl.bal2, 
                        mixpl.ba1,mixpl.ba2, 
                        mixpl.asp1, mixpl.asp2,ncol=2)
                        # layout_matrix = lay, 
