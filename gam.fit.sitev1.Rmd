...
asp.sincos <- gam(bai~s(DIAMETER) + s(asp_cos) + s(asp_sin) + s(slope_pct) + s(elev_m) + ti(asp_cos, asp_sin), family = 'Gamma'(link = log), data = bai.site[bai.site$unique_tree_id != 15431,], method = 'ML')

asp.sincosa <- gam(bai~s(DIAMETER) + s(asp_cos) + s(asp_sin) + s(slope_pct) + s(elev_m), family = 'Gamma'(link = log), data = bai.site[bai.site$unique_tree_id != 15431,], method = 'ML')

asp.sincosb <- gam(bai~s(DIAMETER) + s(asp_cos) + s(asp_sin) + s(slope_pct), family = 'Gamma'(link = log), data = bai.site[bai.site$unique_tree_id != 15431,], method = 'ML')

asp.sincosc <- gam(bai~s(DIAMETER) + s(asp_cos) + s(asp_sin), family = 'Gamma'(link = log), data = bai.site[bai.site$unique_tree_id != 15431,], method = 'ML')

asp.sincosd <- gam(bai~s(DIAMETER) + s(asp_cos) + s(asp_sin) + s(elev_m), family = 'Gamma'(link = log), data = bai.site[bai.site$unique_tree_id != 15431,], method = 'ML')

asp.sincos1 <- gam(bai~s(DIAMETER) + s(asp_cos, asp_sin) + s(elev_m) + s(slope_pct), family = 'Gamma'(link = log), data = bai.site[bai.site$unique_tree_id != 15431,], method = 'ML')

asp.sincos2 <- gam(bai~s(DIAMETER) + s(asp_cos, asp_sin) + s(elev_m), family = 'Gamma'(link = log), data = bai.site[bai.site$unique_tree_id != 15431,], method = 'ML')

asp.sincos3 <- gam(bai~s(DIAMETER) + s(asp_cos, asp_sin) + s(slope_pct), family = 'Gamma'(link = log), data = bai.site[bai.site$unique_tree_id != 15431,], method = 'ML')

trasp1 <- gam(bai~s(DIAMETER) + s(asp.trasp) + s(elev_m) + s(slope_pct), family = 'Gamma'(link = log), data = bai.site[bai.site$unique_tree_id != 15431,], method = 'ML')

trasp2 <- gam(bai~s(DIAMETER) + s(asp.trasp) + s(elev_m), family = 'Gamma'(link = log), data = bai.site[bai.site$unique_tree_id != 15431,], method = 'ML')

trasp3 <- gam(bai~s(DIAMETER) + s(asp.trasp) + s(slope_pct), family = 'Gamma'(link = log), data = bai.site[bai.site$unique_tree_id != 15431,], method = 'ML')

noasp1 <- gam(bai~s(DIAMETER) + s(elev_m) + s(slope_pct), family = 'Gamma'(link = log), data = bai.site[bai.site$unique_tree_id != 15431,], method = 'ML')

noasp2 <- gam(bai~s(DIAMETER) + s(slope_pct), family = 'Gamma'(link = log), data = bai.site[bai.site$unique_tree_id != 15431,], method = 'ML')

noasp3 <-  gam(bai~s(DIAMETER) + s(elev_m), family = 'Gamma'(link = log), data = bai.site[bai.site$unique_tree_id != 15431,], method = 'ML')


#trasp2 <- gam(bai~s(DIAMETER) + s(asp.trasp) + s(elev_m) + s(slope_pct) + ti(asp.trasp, elev_m, bs = 'ts') + ti(asp.trasp, slope_pct, bs = 'ts') + ti(elev_m, slope_pct, bs = 'ts') + ti(asp.trasp, elev_m, slope_pct, bs = 'ts'), family = 'Gamma'(link = log), data=bai.site, method = 'ML')

#trasp2a <- gam(bai~s(DIAMETER) + s(asp.trasp) + elev_m + s(slope_pct) + ti(asp.trasp, elev_m) + ti(asp.trasp, slope_pct) + ti(elev_m, slope_pct), family = 'Gamma'(link = log), data=bai.site, method = 'ML')
...
#asp.sincos2 <- gam(bai~s(DIAMETER) + s(asp_cos, asp_sin) + s(elev_m, sp = 3) + s(slope_pct), family = 'Gamma'(link = log), data = bai.site[bai.site$unique_tree_id != 15431,], method = 'ML')
summary(asp.sincos2)
...
#full SI version
gam.site.full3 <- gam(bai~s(DIAMETER) + s(mean_si), family = 'Gamma'(link=log), data = bai.site[bai.site$unique_tree_id != 15431,], method = 'ML')

#full aspect version
gam.site.full4 <- asp.sincos3

#full heatload version
gam.site.full5 <- gam(bai~s(DIAMETER) + s(heatload), family = 'Gamma'(link=log), data = bai.site[bai.site$unique_tree_id != 15431,], method = 'ML')

#using stand as an indicator of site conditions
gam.site.full.6 <- gam(bai~as.factor(stand) +s(DIAMETER), family = 'Gamma'(link = log), data = bai.site[bai.site$unique_tree_id != 15431,], method = 'ML')
