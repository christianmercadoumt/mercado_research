...
```{r 3.1 raw data trends}
# library(gtable)
library(grid)
dat <- bai.spmx.ids %>% select(SETTING_ID, stand, MEASUREMENT_NO, PLOT, unique_tree_id, 
...
(bai.diam.asp.bah <- ggplot(ind.tr.dat, aes(diam.cm, bai.cmsq)) + geom_point(alpha = 0.2) + 
