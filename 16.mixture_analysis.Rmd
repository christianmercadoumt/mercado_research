...
plot_difference(mix.diff.gam, series = DIAMETER, difference = list(omixtype = c('laoc', 'pico')))
plot_difference(mix.diff.gam, series = DIAMETER, difference = list(omixtype = c('laoc', 'psme')))
plot_difference(mix.diff.gam, series = cr, difference = list(omixtype = c('laoc', 'psme')))
plot_difference(mix.diff.gam, series = cr, difference = list(omixtype = c('laoc', 'pico')))
plot_smooths(mix.diff.gam, series = DIAMETER, comparison = omixtype)
