...
try(mix.diff.gam <- bam(bai~ mixtype + s(DIAMETER) + s(DIAMETER, by = omixtype) + 
...
try(saveRDS(mix.diff.gam, 'data/model_objects.1/mix.diff.gam.rds'))
...
plot(diam.diff.gam)
summary(diam.diff.gam)

summary(mix.diff.gam)

summary(o.mixtures.all$omixtype)
